...
const Header: React.FC<HeaderProps> = ({ toggleChatbot }) => {
    ...
    <nav className={`bg-gray-800 shadow-lg fixed w-full z-50 transition-all duration-300 ${isScrolled ? 'py-3 bg-opacity-95' : 'py-4'}`}>
      <div className="container mx-auto px-4 flex justify-between items-center">
        ...
        <div className="md:hidden flex items-center space-x-4">
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" viewBox="0 0 24 24" fill="currentColor">
              <path d="M20 2H4c-1.103 0-2 .897-2 2v18l5.333-4H20c1.103 0 2-.897 2-2V4c0-1.103-.897-2-2-2zm-2 12H6v-2h12v2zm0-3H6V9h12v2zm0-3H6V6h12v2z"/>
            </svg>
          </button>
          <button
        ...
        <div className="hidden md:flex space-x-8 items-center">
          ...
          <button
            onClick={toggleChatbot}
            className="text-gray-400 hover:text-white focus:outline-none focus:text-white focus:ring-2 focus:ring-indigo-500 rounded-md p-2 ml-4"
            aria-label="Open AI Chatbot"
